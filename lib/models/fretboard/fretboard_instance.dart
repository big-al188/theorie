...
class FretboardInstance {
  ...
  bool showOctave; // NEW: Show octave note in scale modes
  ...
  FretboardInstance({
    ...
    this.showOctave = false, // NEW: Default to false
  ...
  factory FretboardInstance.defaults(String id) {
    return FretboardInstance(
      ...
      showOctave: false, // NEW: Default to false
      visibleFretEnd: 12,
    );
  }
  ...
  FretboardConfig toConfig({
    ...
    return FretboardConfig(
      ...
      showOctave: showOctave, // Use the instance's showOctave setting
      width: 400.0,
      height: 300.0,
